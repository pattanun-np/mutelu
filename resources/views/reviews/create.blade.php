...
@section('content')
<style>
    /* Ensure stars are clickable even if JavaScript fails */
    ...
    @if(!old('rating'))
        #rating-5:checked + label,
        #rating-4:checked + label,
        #rating-3:checked + label,
        #rating-2:checked + label,
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Write a Review for {{ $sacredplace->name }}</h1>
        </div>

        <div class="bg-white rounded-lg shadow-sm p-6">
            <form action="{{ route('reviews.store') }}" method="POST">
                @csrf
                <input type="hidden" name="sacredplace_id" value="{{ $sacredplace->id }}">
